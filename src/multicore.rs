...
pub fn launch_core1_with_stack(
	...
	let enabled = cortex_m::peripheral::NVIC::is_enabled(crate::pac::Interrupt::SIO_IRQ_FIFO);
	cortex_m::peripheral::NVIC::mask(crate::pac::Interrupt::SIO_IRQ_FIFO);
	...
	if enabled {
		unsafe { cortex_m::peripheral::NVIC::unmask(crate::pac::Interrupt::SIO_IRQ_FIFO) };
	}
